...
namespace PlainElastic.Net.Tests.Builders.Commands
{
    ...
    class When_Create_Bulk_operation_built
    {
        Establish context = () => {
        ...
        Because of = () => result = new BulkBuilder(serializerMock.Object)
                                            .Create(data: document, index: "test", type: "type1", id: document.StringProperty, customOptions: "custom options",
        ...
        It should_return_correct_value = () =>
            result.ShouldEqual(("{ 'create': { '_index': 'test','_type': 'type1','_id': '1','_version_type': 'external','_version': 100,'_routing': 'routing','_percolate': 'percolate','_parent': 'parent','_timestamp': 'timestamp','_ttl': 'ttl',custom options } }\n" +
                                "{ Serialized Object }\n"
                               ).AltQuote());
