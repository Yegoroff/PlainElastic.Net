...
namespace PlainElastic.Net.Queries
{
    ...
    /// </summary>
	public class StatsAggregation<T> : AggregationBase<StatsAggregation<T>, T>
    {
        private readonly List<string> aggregationFields = new List<string>();

        /// <summary>
		/// The field to execute stats aggregation against.
        /// </summary>
		public StatsAggregation<T> Field(string fieldName)
        {
		...
		/// The field to execute stats aggregation against.
        /// </summary>
		public StatsAggregation<T> Field(Expression<Func<T, object>> field)
        {
		...
		/// The field to execute stats aggregation against.
        /// </summary>
		public StatsAggregation<T> FieldOfCollection<TProp>(Expression<Func<T, IEnumerable<TProp>>> collectionField, Expression<Func<TProp, object>> field)
        {
        ...
        /// <summary>
        /// Allow to define a script to evaluate, with its value used to compute the stats information.
        /// </summary>
		public StatsAggregation<T> Script(string script)
        {
        ...
        /// </summary>
		public StatsAggregation<T> Lang(string lang)
        {
        ...
        /// see: http://www.elasticsearch.org/guide/reference/modules/scripting.html
        /// </summary>
		public StatsAggregation<T> Lang(ScriptLangs lang)
        {
        ...
        /// </summary>
		public StatsAggregation<T> Params(string paramsBody)
        {
